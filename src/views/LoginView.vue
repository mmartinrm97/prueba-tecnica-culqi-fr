<template>
  ...
  <div class="flex w-1/2 flex-col justify-center">
    <div class="my-auto flex flex-col justify-center px-8 lg:px-14 xl:px-24">
      ...
      <div class="pt-40">
        <h1
            class="whitespace-nowrap text-center text-3xl font-bold leading-loose tracking-wide"
        >
          Inicia sesión
        </h1>
        <form action="">
    ...
    <!-- Terms Section -->
    <div
        class="flex flex-col items-center justify-center whitespace-nowrap p-10 text-center"
    >
      <span class="text-gray-500"
      >© 2023 Culqi. Todos los derechos reservados.</span
      >
    </div>
  </div>
</template>
